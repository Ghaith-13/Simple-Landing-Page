  ...
  return (
    <div style={{backgroundColor:`${color}`}} className='fixed top-0 left-0 w-full z-10 ease-in duration-300'>
        <div className='max-w-[1240px] flex justify-between p-4 text-white items-center'>
            ...
            {/* Mobile menu */}
            <div className={nav?'sm:hidden absolute top-0 bottom-0 right-0 left-0 flex justify-center items-center bg-black text-center ease-in duration-300 h-screen w-full':'sm:hidden absolute top-0 bottom-0 right-0 left-[-100%] flex justify-center items-center bg-black text-center ease-in duration-300 h-screen w-full'}
            >
              <ul>
                  <li>
