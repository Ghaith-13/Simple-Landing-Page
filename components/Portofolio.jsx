    ...
    <div className='max-w-[1240px] mx-auto py-15 text-center'>
        ...
        <div className='grid grid-rows-none md:grid-cols-5 md:gap-4 p-4 '>
            ...
            <div className='w-full h-full col-span-2 md:col-span-3 row-span-2'>
              <Image src={img1} alt='/' className='w-677 h-full' layout='responsive' />
            </div>
            ...
            <div className='w-full h-full'>
             <Image src={img3} alt='/' className='w-215 h-full object-cover' layout='responsive' />
            </div>
            
            <div className='w-full h-full'>
             <Image src={img4} alt='/' className='w-215 h-full object-cover' layout='responsive' />
            </div>

            <div className='w-full h-full'>
             <Image src={img5} alt='/' className='w-215 h-full object-cover' layout='responsive' />
            </div>
        </div>
